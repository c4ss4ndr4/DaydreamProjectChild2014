...
<head>
	...
	<title>D A Y D R E A M • P R O J E C T | <?php the_title(); ?></title>
...
<!--[if gt IE 8]><!-->
	...
	<nav class="top-bar">
	    <ul class="title-area">
			...
			<!-- this is disabled both the Menu icon and the word menu have been deleted -->
